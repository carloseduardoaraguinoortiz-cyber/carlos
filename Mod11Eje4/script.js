...
function openModal(id){
    ...
    if(img){
        ...
        modalInfo.innerHTML = `<strong>${img.name}</strong><br>Tamaño: ${formatSize(img.size)}<br>Tipo: ${img.type}`;
...
clearAllBtn.addEventListener('click', ()=>{
    if(confirm('¿Eliminar todas las imágenes?')){ images=[]; renderGallery(); updateStats(); }
});
...
console.log('📸 Galería Pro inicializada');
